...
A somewhat uninnovative, non-competitive UCI chess engine for trolling (same old search techniques and heuristics). I had ~~1 week~~ 2 weeks to work on this engine to brush up on Julia and to correct some bugs from my previous C++ engine. Julia, like Python, is highly portable and easy on the eyes (this is probably the only thing interesting about this engine). At the moment, the engine won't be worked on regularly, but I might try a few patches here and there during free time.
